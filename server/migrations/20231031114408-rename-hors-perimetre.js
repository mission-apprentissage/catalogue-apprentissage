// Transformation de toutes les occurrences de "hors périmètre" en "non publiable en l'état"
module.exports = {
  async up(db) {
    ...
    await formations.updateMany(
      ...
      { $set: { "parcoursup_statut_history.$[e].parcoursup_statut": "non publiable en l'état" } },
      {
    ...
    await formations.updateMany(
      ...
      { $set: { "affelnet_statut_history.$[e].affelnet_statut": "non publiable en l'état" } },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].from.parcoursup_statut": "non publiable en l'état" },
      },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].to.parcoursup_statut": "non publiable en l'état" },
      },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].from.affelnet_statut": "non publiable en l'état" },
      },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].to.affelnet_statut": "non publiable en l'état" },
      },
      {
    ...
    await reglesPerimetres.updateMany({ statut: "hors périmètre" }, { $set: { statut: "non publiable en l'état" } });
    ...
    await reglesPerimetres.updateMany(
      ...
      {
        $set: { "updates_history.$[e].from.statut": "non publiable en l'état" },
      },
      {
    ...
    await reglesPerimetres.updateMany(
      ...
      {
        $set: { "updates_history.$[e].to.statut": "non publiable en l'état" },
      },
      {
