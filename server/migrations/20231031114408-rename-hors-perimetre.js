// Transformation de toutes les occurrences de "hors périmètre" en "non intégrable"
module.exports = {
  async up(db) {
    ...
    await formations.updateMany(
      ...
      { $set: { parcoursup_statut: "non intégrable" } }
    );
    await formations.updateMany({ affelnet_statut: "hors périmètre" }, { $set: { affelnet_statut: "non intégrable" } });
    ...
    await formations.updateMany(
      ...
      { $set: { "parcoursup_statut_history.$[e].parcoursup_statut": "non intégrable" } },
      {
    ...
    await formations.updateMany(
      ...
      { $set: { "affelnet_statut_history.$[e].affelnet_statut": "non intégrable" } },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].from.parcoursup_statut": "non intégrable" },
      },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].to.parcoursup_statut": "non intégrable" },
      },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].from.affelnet_statut": "non intégrable" },
      },
      {
    ...
    await formations.updateMany(
      ...
      {
        $set: { "updates_history.$[e].to.affelnet_statut": "non intégrable" },
      },
      {
    ...
    await reglesPerimetres.updateMany({ statut: "hors périmètre" }, { $set: { statut: "non intégrable" } });
    ...
    await reglesPerimetres.updateMany(
      ...
      {
        $set: { "updates_history.$[e].from.statut": "non intégrable" },
      },
      {
    ...
    await reglesPerimetres.updateMany(
      ...
      {
        $set: { "updates_history.$[e].to.statut": "non intégrable" },
      },
      {
    ...
    await previousSeasonFormations.updateMany(
      ...
      { $set: { affelnet_statut: "non intégrable" } }
    );
  },
