...
exception="(package.json|custom-environment-variables.json|manifest.json|locales/.*.json|latest_public_ofs.csv|catalogue-formations-apprentissage.*.json|sample.json"
exception="$exception)$"
