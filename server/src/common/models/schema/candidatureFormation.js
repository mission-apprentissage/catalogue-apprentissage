...
const candidatureFormationSchema = {
  affelnet_id: {
    index: true,
    type: String,
    default: null,
    description: "Affelnet ID de la formation",
    validate: {
      validator: (value) => !!value && !!value.length,
      message: (props) => `${props.value} n'est pas une code valide.`,
    },
  },
  ...
  academie_formation: {
    ...
    type: String,
    default: null,
    description: "Académie de la formation",
    validate: {
      validator: (value) => !!value && !!value.length,
  ...
  code_offre_formation: {
    ...
    type: String,
    default: null,
    description: "Code offre de la formation",
    validate: {
      validator: (value) => !!value && !!value.length,
      message: (props) => `${props.value} n'est pas un code offre valide.`,
    },
  },
  localite_formation: {
    index: false,
    type: String,
    default: [],
    description: "Localité de l'établissement d'accueil",
    // validate: {
    //   validator: (value) => !!value && !!value.length,
  ...
  uai_formation: {
    ...
    type: String,
    default: [],
    description: "UAI de l'établissement d'accueil",
    // validate: {
    //   validator: (value) => !!value && !!value.length,
    //   message: (props) => `${props.value} n'est pas une raison sociale valide.`,
    // },
...
module.exports = candidatureFormationSchema;
