...
const HowToReglement = () => {
  return (
    <Box color={"grey.800"} py={12}>
      ...
      <br />
      <p>
        Avant de référencer un organisme et son offre de formation en apprentissage, les services académiques vérifient
        leur éligibilité.
        <br />
            ...
            {({ isExpanded }) => (
              <>
                ...
                <AccordionPanel pb={4}>
                  <UnorderedList>
                    ...
                    <ListItem>
                      ...
                      <OrderedList>
                        ...
                        <ListItem>
                          les établissements sont déclarés en préfecture <strong>ET</strong> attestent de leur qualité
                          par une certification Qualiopi demandée directement dans la liste des certificateurs habilités
                          <UnorderedList styleType="square">
                  ...
                  <br />
                  <Text as="span" color="#7d4e5b">
                    Si l’une de ces conditions n’est pas remplie, l’établissement figure dans le catalogue non-éligible
                  </Text>
                </AccordionPanel>
              </>
            )}
          ...
          <AccordionItem border="none">
            {({ isExpanded }) => (
              <>
                ...
                <AccordionPanel pb={4}>
                  Dès lors que l’établissement est habilité à délivrer le titre ou diplôme, que celui-ci est réalisé par
                  ...
                  <UnorderedList>
                    <ListItem>
                      ...
                      qu’il s’agisse ou non d’un titre ou diplôme délivré au nom de l’Etat. Dès lors que l’établissement
                      est habilité à délivrer le titre ou diplôme et que celui-ci est réalisé par voie d’apprentissage.
                      <UnorderedList styleType="circle">
                        <ListItem>
                          <Text as="span" color="#7d4e5b">
                ...
                <AccordionPanel pb={4}>
                  <UnorderedList>
                    <ListItem>
                      ...
                      Toutes les formations enregistrées au RNCP et pour lesquelles l'établissement est soit l’autorité
                      responsable de la certification, soit partenaire de l’autorité certificatrice et que le titre est
                    ...
                    <ListItem>
                      ...
                      <UnorderedList styleType="circle">
                        <ListItem>
                          ...
                          jour éventuelle des données (validité, certificateur et/ou établissements partenaires, voie(s)
