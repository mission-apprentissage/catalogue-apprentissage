        ...
        <Link as={NavLink} to={`/etablissement/${formation.etablissement_formateur_id}`} variant="card">
          ...
          <Box my={2}>
            <Flex>
              ...
              <ActifBadge values= {{etablissement_gestionnaire_actif: formation.etablissement_gestionnaire_actif, etablissement_formateur_actif:formation.etablissement_formateur_actif }}  m="0" mr={[0, 2]} />
            </Flex>
          </Box>
          <Heading textStyle="h6" color="grey.800" my={1}>
